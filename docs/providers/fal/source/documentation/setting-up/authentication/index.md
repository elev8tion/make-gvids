...
**Source:** https://fal.ai/docs/documentation/setting-up/authentication/index.md
...
> **💡  Tip:** **Best practice**: Use environment variables instead of hardcoding keys in your code. This keeps your keys secure and makes it easy to use different keys for development and production.
...
> **📝  Note:** If you're not sure which to choose, start with **API** scope. You can always create an additional **ADMIN** key later if you need to deploy models.
