...
**Source:** https://fal.ai/docs/documentation/model-apis/common-parameters.md
...
- **[Data Retention & Storage](/documentation/model-apis/media-expiration)** — Full guide to media expiration, payload retention, and the delete API
...
> **📝  Note:** This only prevents storage of the JSON payloads. CDN files generated during processing are still accessible (subject to [media expiration](/documentation/model-apis/media-expiration) settings).
...
- **[Reliability & Retries](/documentation/model-apis/inference/reliability)** — Learn more about automatic retries, fallbacks, and error handling
...
- **[Reliability & Retries](/documentation/serverless/reliability/retries#per-request-client-side-control)** — Per-condition budgets, the overall attempt ceiling, and precedence rules
...
- **[Reliability & Retries](/documentation/model-apis/inference/reliability)** — Learn more about model fallbacks
...
> **📝  Note:** This parameter is passed as a query parameter on the URL, not as a header. The SDKs do not currently expose it as a named parameter; use the raw URL approach or pass it via `headers`.
...
- **[Common Model Arguments](/documentation/model-apis/model-arguments)** — Common input parameters like seed, image\_size, and safety checker that appear across many models
