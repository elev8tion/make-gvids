...
**Source:** https://fal.ai/docs/documentation/model-apis/media-expiration.md
...
> **⚠️  Warning:** Expired files are permanently deleted and cannot be recovered. Download files before they expire if you need them later.
...
> **📝  Note:** This prevents storage of the JSON payloads only. CDN files generated during processing are still accessible (subject to the media expiration setting above).
...
- **[Delete Request Payloads API](/platform-apis/v1/models/requests/payloads)** — Delete IO payloads and CDN output files for a specific request

> **📝  Note:** CDN files found in the **input** of a request are not deleted, as they may be used by other requests.
