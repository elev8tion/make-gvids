...
**Source:** https://fal.ai/docs/documentation/model-apis/pricing.md
...
> **📝  Note:** Prices vary by model and may change. Check the model's page or the [pricing page](https://fal.ai/pricing) for current rates. You can also query prices programmatically through the [Platform APIs](/api-reference/platform-apis/for-models).
...
- **[Platform APIs for Models](/api-reference/platform-apis/for-models)** — Full reference for pricing, usage, and analytics APIs
...
The billing dashboard shows your overall spend, invoices, and payment history. For per-model cost breakdowns and request-level detail, use the usage and analytics Platform APIs, or check the billing reports available in the dashboard.
  ...
  - **[Dashboard Billing](https://fal.ai/dashboard/billing)** — View your overall spend, invoices, and payment methods

  - **[Concurrency Limits](/documentation/model-apis/concurrency-limits)** — Understand how credit purchases affect your concurrency limit
