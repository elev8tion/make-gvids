...
**Source:** https://fal.ai/docs/documentation/model-apis/errors.md
...
> **⚠️  Warning:** Some APIs are still being migrated to this error structure. Not all endpoints strictly follow the format documented below yet.
...
> **📝  Note:** This error format is different from [model-level errors](#error-types), which return a `detail` array of error objects. Request errors return a flat object with `detail` as a string.
