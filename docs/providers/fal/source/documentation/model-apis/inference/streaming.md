...
**Source:** https://fal.ai/docs/documentation/model-apis/inference/streaming.md
...
> **📝  Note:** Streaming is only supported by models that have a `/stream` endpoint. Check the model's API page to confirm support before using `stream()`.
