...
**Source:** https://fal.ai/docs/documentation/model-apis/inference/client-setup.md
...
> **📝  Note:** **Java Async Support** -- If your code relies on asynchronous operations via `CompletableFuture` or `Future`, use the `ai.fal.client:fal-client-async` artifact instead.
...
- **[Proxy Setup](/documentation/model-apis/inference/proxy-setup)** — Pages Router, Vercel, Express, custom frameworks, and how the proxy works under the hood
...
## API References and Support
  ...
  - **[JavaScript / TypeScript](https://fal-ai.github.io/fal-js/reference)** — API docs and [GitHub repo](https://github.com/fal-ai/fal-js)

  - **[Python](https://fal-ai.github.io/fal/client)** — API docs and [GitHub repo](https://github.com/fal-ai/fal)

  - **[Swift (iOS)](https://swiftpackageindex.com/fal-ai/fal-swift/documentation/falclient)** — API docs and [GitHub repo](https://github.com/fal-ai/fal-swift)

  - **[Java / Kotlin](https://fal-ai.github.io/fal-java/fal-client/index.html)** — API docs and [GitHub repo](https://github.com/fal-ai/fal-java)

  - **[Dart (Flutter)](https://pub.dev/documentation/fal_client/latest)** — API docs and [GitHub repo](https://github.com/fal-ai/fal-dart)

  - **[Community](https://discord.gg/fal-ai)** — Get help on Discord
