...
**Source:** https://fal.ai/docs/documentation/model-apis/sandbox.md
...
## Try it
  ...
  - **[Generate an Image](https://fal.ai/sandbox/image/text-to-image)** — Text-to-image with Nano Banana 2, FLUX, Recraft, and more

  - **[Generate a Video](https://fal.ai/sandbox/video/image-to-video)** — Image-to-video with Veo 3.1, Kling, Sora 2, and more

  - **[Generate Music](https://fal.ai/sandbox/audio/text-to-music)** — Text-to-music with ElevenLabs, Beatoven, MiniMax, and more
...
> **📝  Note:** Free credits and free request coupons are only usable in Sandbox and the
...
> **📝  Note:** When running your own apps in Sandbox, cost and duration metrics may not be
...
> **⚠️  Warning:** Apps with validation errors (red icon) cannot be added. You'll need to update
